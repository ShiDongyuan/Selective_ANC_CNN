...
import numpy as np
from FxNLMS_algorithm import FxNLMS_algroithm, train_fxnlms_algorithm
...
def main():
    FILE_NAME_PATH = 'Control_filter_from_15frequencies_Normalized_FxLMS.mat'
    ...
    for ii, F_vector in enumerate( Frequecy_band):
        ...
        controller = FxNLMS_algroithm(Len=Len_control)
        
        Erro = train_fxnlms_algorithm(Model=controller,Ref=Fx, Disturbance=Dis,Stepsize = 0.1)
